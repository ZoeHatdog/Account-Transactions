    ...
    def upload_file(self):
        ...
        if file_path:
            ...
            if bsp_rate_value is not None:
                ...
                messagebox.showerror("ERROR", "BSP RATE NOT FOUND")
                return
                    ...
                    if bsp_rate_column_index is not None:
                        ...
                        if bsp_rate_column_letter:
                            ...
                            try:
                                ...
                                messagebox.showerror("Error","Permission denied: Ensure the file is not open and you have write permissions.")
                            ...
                            probe_card_value = "{:,}".format(probe_card_value)
                            probe_cardv_value = "{:,}".format(probe_cardv_value)
                            fabrication1_value = "{:,}".format(fabrication1_value)
                            fabrication2_value = "{:,}".format(fabrication2_value)
                            fabrication3_value = "{:,}".format(fabrication3_value)
                            total_total_value = "{:,}".format(total_total_value)
                            ...
                            try:
                                ...
                                messagebox.showerror("Permission denied: Ensure the file is not open and you have write permissions.")
                            except Exception as e:
